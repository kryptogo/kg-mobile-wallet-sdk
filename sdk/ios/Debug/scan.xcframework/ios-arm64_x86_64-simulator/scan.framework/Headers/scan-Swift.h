...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="scan",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4scan16ScanPlatformView")
...
SWIFT_CLASS("_TtC4scan8ScanView")
@interface ScanView : UIView <AVCaptureMetadataOutputObjectsDelegate, FlutterPlugin>
...
SWIFT_CLASS("_TtC4scan15ScanViewFactory")
@interface ScanViewFactory : NSObject <FlutterPlatformViewFactory>
- (nonnull instancetype)initWithRegistrar:(id <FlutterPluginRegistrar> _Nullable)registrar OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC4scan15SwiftScanPlugin")
@interface SwiftScanPlugin : NSObject <FlutterPlugin>
+ (void)registerWithRegistrar:(id <FlutterPluginRegistrar> _Nonnull)registrar;
- (void)handleMethodCall:(FlutterMethodCall * _Nonnull)call result:(FlutterResult _Nonnull)result;
